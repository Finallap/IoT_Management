          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <div class="chart">
                    <canvas id="areaChart" style="height: 271px; width: 554px;" width="554" height="271"></canvas>
                  </div>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            ...
            <div class="col-md-6">
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                  <div class="chart">
                    <canvas id="lineChart" style="height: 271px; width: 554px;" width="554" height="271"></canvas>
                  </div>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
