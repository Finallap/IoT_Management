	...
	<div class="content-wrapper" style="min-height: 916px;">
        ...
        <section class="content">
          ...
          <div class="box box-primary">
          	<!-- form start -->
            <form role="form" method="get" action="DataView">
                  		...
                  		<div class="form-group">
                    		...
                    		<select id="device" name="deviceid" class="form-control select2 select2-hidden-accessible"  style="width: 100%;" tabindex="-1" aria-hidden="true">
                    			<c:forEach var="SensingDevice" items="${requestScope.SensingDeviceList}" varStatus="status">
                     	 			<option value="${SensingDevice.sensingDeviceId}" <c:if test="${SensingDevice.sensingDeviceId==currentDeviceID}"> selected="selected" </c:if> >${SensingDevice.deviceName}</option>
                     	 		</c:forEach>
                    		</select>
                   		</div>
					</div>
          ...
          <div class="box box-info">
                <div class="box-body">
                  <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                    ...
                    <tbody> 
                    	<c:forEach var="DataLog" items="${requestScope.pagebean.contentData}" varStatus="status">  
