...
/**
 * Servlet implementation class EditConfigType
 */
@WebServlet("/EditConfigType")
public class EditConfigType extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditConfigType() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String result = CloudClient.getInstance().client.updateConfigType(typeid, typename, mark);
