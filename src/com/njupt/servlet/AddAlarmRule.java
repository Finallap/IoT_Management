...
/**
 * Servlet implementation class AddAlarmRule
 */
@WebServlet("/AddAlarmRule")
public class AddAlarmRule extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String result = CloudClient.getInstance().client.addAlarmRule(userid, deviceid, typeid, rule, threshold);
			if (result.contains("success")) {
				out.println("<script>alert('告警规则添加成功!');location.href='ViewSensingDevice?deviceid="+deviceid+"';</script>");
			}
